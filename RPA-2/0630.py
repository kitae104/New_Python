...
#===============================================================레이아웃==========================================================#
        ...
        self.btn1 = QPushButton("",self) # up
        self.btn2 = QPushButton("",self) # start
        self.btn3 = QPushButton("",self) # down
        self.btn4 = QPushButton("",self) # save
        self.btn5 = QPushButton("",self)  # attedit
        self.btn6 = QPushButton("",self) # loading
        self.btn7 = QPushButton("",self) # remove
        self.btn8 = QPushButton("",self) # addscript
        self.btn9 = QPushButton("",self)  # removeall
