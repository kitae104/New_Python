...
print('X_for_fc :',X_for_fc) # Tensor("Reshape:0", shape=(?, 25), dtype=float32)

outputs = tf.contrib.layers.fully_connected(inputs=X_for_fc, num_outputs=num_classes, activation_fn=None)
print('outputs :', outputs)  # Tensor("fully_connected/BiasAdd:0", shape=(?, 25), dtype=float32)
