...
# 오버피팅을 재현하기 위해 학습 데이터 수를 줄임(60,000개중 300개만 사용)
x_train = x_train[:300]
t_train = t_train[:300]
...
for i in range(1000000000):
    batch_mask = np.random.choice(train_size, batch_size)   # 미니배치 선택
    x_batch = x_train[batch_mask]                           # 학습 데이터
    t_batch = t_train[batch_mask]                           # 정답 데이터
